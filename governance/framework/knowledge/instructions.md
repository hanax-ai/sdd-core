...
file and the global playbook conflict on domain-scoped matters, this file
wins.
...
4. **Project mirror registry** — this playbook (`governance/framework/knowledge/instructions.md`)
