# Governance-Framework — Domain Playbook

Domain-local operating instructions for agents working inside
`governance/framework/` (the workspace governance design layer).
...
The canonical index of definitional artifacts this internal domain owns. Every
...
|----|----------|------|---------|--------|-------------|
| ST-001 | [`../standards/deliverables-ownership.md`](../standards/deliverables-ownership.md) — portable Deliverables & Ownership definitions; live assignments remain adopter-owned | standard | 1.0.0 | active | — (direct governed change on maintainer directive 2026-07-20; reset-v4 ownership boundary applied 2026-07-28) |
...
> ([`../skills/mirror-sync/SKILL.md`](../skills/mirror-sync/SKILL.md)),
...
4. **Domain grounding registry** — this playbook (`governance/framework/knowledge/instructions.md`)
5. **Active feature folder** — `../docs/specs/<NNN-feature-name>/` (`spec.md`, and its
   `plan.md` / `tasks.md` only when working those stages)

**Domain-local refinement (labeled as such — an addition to, not a change of, the
...
> ([`../skills/mirror-sync/SKILL.md`](../skills/mirror-sync/SKILL.md)):
> it resolves the global registry first, then this table, and stops — never
