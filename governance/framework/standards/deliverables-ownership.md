...
## 4. Maintenance standard for the adopter-side inventory

Every live inventory governed by these rules is adopter-side: it belongs in
the independent adopter repository or authorized coordination system that owns
the work. SDD-Core defines the reusable register shape and carries no live
