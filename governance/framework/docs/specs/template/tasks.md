...
```text
1. Read the root constitution: .specify/memory/constitution.md
2. Read the GLOBAL grounding registry: knowledge/instructions.md
3. Read the domain constitution: governance/framework/constitution.md
4. Read the domain grounding registry:
   governance/framework/knowledge/instructions.md
5. Read plan.md in this feature folder
...
7. Generate tasks by phase (Setup → Validation First → Core Authoring →
...
9. Number tasks sequentially (T001, T002, ...)
10. Fill Dependencies section and Validation Checklist
11. Return: SUCCESS (tasks ready for agent execution)
```
...
- Every file path cited by a task MUST resolve inside the owning domain tree, `governance/framework/`
...
- [ ] T011 [Update domain indexes/instructions if plan.md requires] — `governance/framework/knowledge/instructions.md`
