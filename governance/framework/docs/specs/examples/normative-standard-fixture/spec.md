...
**Input**: Description: "Every entry in the synthetic domain glossary must cite the standard that defines its term, so glossary text cannot drift from its defining standards."
