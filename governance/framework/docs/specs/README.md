...
## Template sets in this internal domain

- `template/` — **normative-standard shape** (this internal domain's default): for
...
- `template-software/` — **software/product shape**: the workspace's single
  ...
  `test-runtime` (classic TDD). Not for governance features in this internal domain.
