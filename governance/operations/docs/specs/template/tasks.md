...
**Input**: Design documents from `governance/operations/docs/specs/[###-capability-name]/`
...
3. Consult context (files only — no tools required):
   ...
   → Domain scope constitution: governance/operations/constitution.md
...
4. Generate tasks by phase (Setup → Validation First → Core Authoring →
   ...
   → Every cited path is inside governance/operations/ (see Scope Rule)
5. Apply task rules:
...
- Every file path cited by a task MUST resolve inside the owning domain tree, `governance/operations/`
- Tasks MUST NOT create, modify, or delete files in the workspace root, in other domains or repositories, or in global `docs/`, `knowledge/`, or `reference/`
...
- All paths below are relative to the repository root and MUST begin with `governance/operations/`
- Feature documents live in `governance/operations/docs/specs/[###-capability-name]/`
...
- [ ] T001 [Confirm target paths per plan.md Structure Decision] — `governance/operations/[path]`
- [ ] T002 [Scaffold the runbook entry / record template skeleton] — `governance/operations/[path]`
...
- [ ] T003 [Define check: the class-2 execution record conforms to its class-1 template (SC-###)] — `governance/operations/docs/specs/[###-capability-name]/tasks.md`
- [ ] T004 [Define check: register row cites its evidence record (SC-###)] — `governance/operations/docs/specs/[###-capability-name]/tasks.md`
- [ ] T005 [Name the review gate(s) and the approving authority (SC-###)] — `governance/operations/docs/specs/[###-capability-name]/tasks.md`

## Phase 3.3: Core Authoring

- [ ] T006 [Author the runbook steps: executor + evidence output per step, deviation handling] — `governance/operations/[runbook path]`
- [ ] T007 [P] [Author/update the class-1 record template (synthetic content only)] — `governance/operations/records/templates/[record].template.md`
- [ ] T008 [P] [Author/update reusable register definition per plan.md] — `governance/operations/records/register-definitions/[register-file].md`

## Phase 3.4: Integration & Cross-references

- [ ] T009 [Wire citations: register rows ↔ evidence records ↔ runbook (both directions, exact anchors)] — `governance/operations/[paths]`
- [ ] T010 [Update domain indexes/instructions if plan.md requires] — `governance/operations/knowledge/instructions.md`

## Phase 3.5: Review & Polish

- [ ] T011 [Run every Validation-First mechanical check; record results inline] — `governance/operations/docs/specs/[###-capability-name]/tasks.md`
- [ ] T012 [Named review gate: approving authority verifies criteria + constitutions + evidence class conformance] — `governance/operations/docs/specs/[###-capability-name]/spec.md`
- [ ] T013 [Resolve every deviation or record it in plan.md Complexity Tracking] — `governance/operations/docs/specs/[###-capability-name]/plan.md`
...
Agent A → T007: [class-1 record template] — governance/operations/records/templates/[record].template.md
Agent B → T008: [register definition] — governance/operations/records/register-definitions/[register-file].md
```
...
- Evidence discipline: real execution evidence is class-2 machine-local; only synthetic class-1 templates are committed (domain scope document evidence classes)
...
- [ ] Every cited path is inside `governance/operations/` (Scope Rule satisfied)
