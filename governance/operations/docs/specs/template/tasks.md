...
- Every file path cited by a task MUST resolve inside the owning project tree, `governance/operations/`
...
- [ ] T010 [Update project indexes/instructions if plan.md requires] — `governance/operations/knowledge/instructions.md`
