...
2. **Resolve each unknown by reading workspace knowledge first**:
   ...
   - Project guidance: `governance/operations/knowledge/instructions.md`, `governance/operations/reference/`
...
5. **Record new agent context in project knowledge**: if design introduces conventions future agents must know, append them to `governance/operations/knowledge/instructions.md` directly — keep additions incremental and preserve existing content
