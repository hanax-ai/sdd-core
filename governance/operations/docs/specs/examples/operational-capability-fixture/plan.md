...
**Feature Directory**: `governance/operations/docs/specs/examples/operational-capability-fixture/` | **Date**: 2026-07-25 | **Spec**: [spec.md](./spec.md)
...
**Affected Files**: `governance/operations/knowledge/instructions.md` (runbook entry, synthetic); `governance/operations/records/templates/synthetic-glossary-audit.template.md` (created); `governance/operations/records/register-definitions/synthetic-capability-register.md` (synthetic definition updated)
...
- Isolated Agent Scopes: PASS — all written paths inside `governance/operations/`; glossary read-only.
...
```text
governance/operations/docs/specs/examples/operational-capability-fixture/
...
*Gated by `.specify/memory/constitution.md` (workspace root) and `governance/operations/constitution.md`.*
