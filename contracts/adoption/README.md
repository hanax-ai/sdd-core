...
reference. Custom tailored IDs are unique, and no custom provision may be both
tailored and excluded. Unknown fields, secret-like keys, secret-bearing
allowed-field values, connection material, and personal machine paths are
rejected at any contract depth. YAML is the human-edited installed form; JSON
fixtures are canonical validator cases.
