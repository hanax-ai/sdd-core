...
**Feature Directory**: `projects/governance-framework/docs/specs/examples/normative-standard-fixture/` | **Date**: 2026-07-25 | **Spec**: [spec.md](./spec.md)
...
**Affected Files**: `projects/governance-framework/standards/synthetic-glossary-citation.md` (created); `projects/governance-framework/knowledge/synthetic-glossary.md` (every entry gains a citation; header gains the governing sentinel)
...
- Isolated Agent Scopes: PASS — every affected path is inside `projects/governance-framework/`.
...
```text
projects/governance-framework/docs/specs/examples/normative-standard-fixture/
...
**Structure Decision**: the standard lands in `standards/` beside existing standards; the glossary stays in project knowledge. Both are the established homes for their classes.
...
*Gated by `.specify/memory/constitution.md` (workspace root) and `projects/governance-framework/.specify/memory/constitution.md`.*
