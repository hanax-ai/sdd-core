...
**Artifact Class**: governance-operations (runbook, cadence, evidence capability — see the project constitution's Execution-Evidence Test)
...
<!--
  Bind the capability to the ops evidence system (project constitution's
  evidence classes).
-->

- **Evidence class**: [Class 1 committed policy/template · Class 2 machine-local record · Class 3 external safe-reference — per the project constitution]
