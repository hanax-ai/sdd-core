...
## Template set in this project

- `template/` — **operational-capability shape** (this project's default):
...
- Software/product features do NOT start here: the workspace's single
  ...
  `projects/governance-framework/docs/specs/template-software/`
  (Validation Mode: `test-runtime`). This project holds no copy.
