...
- Amending SYN-ST-900 itself (framework project owns the standard).
...
- **Consulted / informed**: framework project owner on any nonconformance touching SYN-ST-900.
...
- **Evidence class**: Class 1 for the committed synthetic template; Class 2 (machine-local) for real run records — per the project constitution's evidence classes.
...
- SYN-ST-900 and the synthetic glossary exist (see the framework project's normative-standard fixture).
